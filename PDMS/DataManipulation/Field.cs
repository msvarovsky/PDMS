  ...
  /*  public interface IHtmlTag
    ...
    public class LabelField//: IHtmlTag
    {
        ...
        public string HtmlText()
        {
            ...
            InnerTb.InnerHtml = Text;

            tb.InnerHtml = InnerTb.ToString();
    ...
    public class TextBoxField : Field//, IHtmlTag
    {
        ...
        public override string HtmlText()
        {
            ...
            tb2.InnerHtml = tb3.ToString();

            tb.InnerHtml = Label.HtmlText() + tb2.ToString();
    ...
    public class CheckBoxField : Field//, IHtmlTag
    {
        ...
        public override string HtmlText()
        {
            ...
            tbForm.InnerHtml = htmlCheckBoxes;
            tbControl.InnerHtml = tbForm.ToString();


            tb.InnerHtml = label.HtmlText() + tbControl.ToString();
            return tb.ToString();
        }
    }
